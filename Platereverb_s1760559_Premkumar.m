...
update_method = 2;    % 1 - Regular method, 2 - 'Exact' method
...
if material == 1 && input_type == 1
    audiowrite('PlateReverb_s1760559_Premkumar_default_dryout.wav',output_signal,Fs);
elseif material == 2 && input_type == 1
    audiowrite('PlateReverb_s1760559_Premkumar_extra_dryout.wav',output_signal,Fs);
elseif material == 1 && input_type == 2
    audiowrite('PlateReverb_s1760559_Premkumar_default_IR.wav',output_signal,Fs);
else
    audiowrite('PlateReverb_s1760559_Premkumar_extra_IR.wav',output_signal,Fs);
end
...
if input_type == 2
    ...
    ylabel('Frequency (Hz)');
    if material == 1
        image_filename='PlateReverb_s1760559_Premkumar_default_IRspec.png';
        saveas(gcf,image_filename);
    else
        image_filename='PlateReverb_s1760559_Premkumar_extra_IRspec.png';
        saveas(gcf,image_filename);
    end
end
